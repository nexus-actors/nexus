...
function runRoundtripNode(
    ...
    $topology = ClusterTopology::create(
        ...
        seeds: $seeds,
        // SEC-007 fail-closed guard: 0.0.0.0 without TLS requires an explicit opt-in.
        // Safe here — the proof runs on an isolated docker-compose network.
...
function runIdleWindow(
    ...
    int &$suspected,
    int &$down,
    ?LoggerInterface $meshLogger = null,
): string {
