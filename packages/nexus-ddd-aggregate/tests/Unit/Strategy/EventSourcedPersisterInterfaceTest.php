...
#[CoversNothing]
final class EventSourcedPersisterInterfaceTest extends TestCase
{
    #[Test]
    public function loadAcceptsClassStringAndIdentifierAndReturnsOption(): void
    {
        $reflection = new ReflectionClass(EventSourcedPersister::class);
    ...
    #[Test]
    public function persistAcceptsEventSourcedAggregateRootAndReturnsVoid(): void
    {
        $reflection = new ReflectionClass(EventSourcedPersister::class);
        ...
        self::assertSame(EventSourcedAggregateRoot::class, $entityType->getName());
