 ...
 */
final class OtlpExportActor
{
    public function __construct(
        private readonly SpanExporterInterface $spans,
        private readonly ?PushMetricExporterInterface $metrics,
        private readonly ?LogRecordExporterInterface $logs,
