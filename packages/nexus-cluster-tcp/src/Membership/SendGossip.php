 ...
 * path-prefixes. The owning actor (C1.6d) resolves each path-prefix to a live
...
{
    /**
     * @param list<string> $targets Node path-prefixes of the Up peers to receive the gossip.
     */
