 ...
 * @psalm-api
 *
 * Effect: send a HandshakeAck to the connecting peer. When `accepted` is false,
 * `reason` explains the rejection and `view` is empty. When accepted, `view`
 * carries a node path-prefix → host:port snapshot of the local view after merge.
 */
