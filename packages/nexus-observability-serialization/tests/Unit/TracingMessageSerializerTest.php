...
final class TestMessageSerializer implements MessageSerializer
{
    public function __construct(
        private readonly string $serialized = 'serialized-payload',
        private readonly bool $shouldThrow = false,
        private readonly ?object $deserialized = null,
    ) {}
